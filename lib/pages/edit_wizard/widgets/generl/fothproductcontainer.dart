...
class ForthProductContainer extends GetView<EditWizardController> {
              ...
              body: Container(
                ...
                child: Column(
                  children: [
                    ...
                    //     controller.dateController.text = "${controller.selectedDate.value.year}-${controller.selectedDate.value.month}-${controller.selectedDate.value.day}";
                    //
                    //    },
                    //   textAlign: TextAlign.center,
                    //   readOnly: true,
...
class LSwitchListTile extends GetView<EditWizardController> {
  var listSwitchText;
  bool isChecked;
