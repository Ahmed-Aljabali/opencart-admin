                          ...
                          child: SizedBox(
                            ...
                            child: Center(
                              child: DropdownButton<String>(
                                ...
                                hint: const Text("Required"),
                                value:
                                    controller.selectedCheckBoxTaxOption.value,
                                onChanged: (v) {
                                  controller.selectedCheckBoxTaxOption.value =
                                      v!;
                                },
                  ...
                  MaterialButton(
                      ...
                      onPressed: () {
                        checkedBoxModel = CheckBoxDataModel(
                            index: (controller
                                .optWidgetList[index].chbInnerModel.length),
                            optionValue: controller
                                .selectedCheckBoxChooseOption.value
                                .toString(),
                            point: controller.checkBoxPointsChooseOption.value
                                    .toString() +
                                controller.checkboxpoint,
                            tax: controller.selectedCheckBoxTaxOption.value
                                .toString(),
                            price: controller
                                    .selectedCheckBoxPriceChooseOption.value
                                    .toString() +
                                controller.checkBoxPrice.toString(),
                            qty: controller.checkBoxQty.toString(),
                            weight: controller.checkBoxWeightChooseOption.value
                                    .toString() +
                                controller.checkboxweight.toString());
